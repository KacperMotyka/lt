/**
 * @文件名称: DataTableMouseAdapter.java
 * @类路径:   com.rb.lottery.UI.table
 * @描述:     TODO
 * @作者:     robin
 * @时间:     2011-11-10 下午08:17:05
 * @版本:     1.0.0
 */
 ...
 * @修改说明:
 * @作者: robin
 * @创建时间: 2011-11-10 下午08:17:05
 * @版本: 1.0.0
 */

public class DataTableMouseAdapter extends MouseAdapter {
    private static final Logger log = Logger.getLogger(DataTableMouseAdapter.class);
    ...
    public void mouseSingleClicked(MouseEvent e) {
        log.debug("DataTable Single Clicked!");
    }
    ...
    public void mouseDoubleClicked(MouseEvent e) {
        log.debug("DataTable Doublc Clicked!");
    }
}
