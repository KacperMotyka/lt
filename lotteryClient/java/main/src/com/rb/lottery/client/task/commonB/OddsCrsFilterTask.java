/**
 * @文件名称: OddsCrsFilterTask.java
 * @类路径:   com.rb.lottery.task.commonB
 * @描述:     TODO
 * @作者:     robin
 * @时间:     2011-12-16 下午01:29:23
 * @版本:     1.0.0
 */
 ...
 * @修改说明:
 * @作者: robin
 * @创建时间: 2011-12-16 下午01:29:23
 * @版本: 1.0.0
 */

public class OddsCrsFilterTask extends Task {

	private static final Logger log = Logger.getLogger(OddsCrsFilterTask.class);

	private float least;
	private float most;
	private boolean fatal;

	public OddsCrsFilterTask() {
		least = 0;
		most = 5000000;
		this.fatal = false;
	}

	public OddsCrsFilterTask(float least, float most, boolean ft) {
		this.least = least;
		this.most = most;
		this.fatal = ft;
	}
