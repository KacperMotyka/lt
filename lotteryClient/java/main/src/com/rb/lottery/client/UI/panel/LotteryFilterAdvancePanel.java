/**
 * @文件名称: LotteryFilterAdvancePanel.java
 * @类路径:   com.rb.lottery.UI.panel
 * @描述:     TODO
 * @作者:     robin
 * @时间:     2011-11-13 下午05:08:36
 * @版本:     1.0.0
 */
...
public class LotteryFilterAdvancePanel extends JPanel {
	...
	private void initFilterAdvanceBPane() {
		...
		advanceBBtn1 = new JButton(new ImageIcon(
		...
		advanceBBtn2 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn3 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn4 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn5 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn6 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn7 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn8 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn9 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn10 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn11 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn12 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn13 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceBBtn14 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
	...
	private void initFilterAdvanceAPane() {
		...
		advanceABtn1 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn2 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn3 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn4 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn5 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn6 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn7 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn8 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn9 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn10 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn11 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn12 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn13 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn14 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn15 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn16 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn17 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
		...
		advanceABtn18 = new JButton(new ImageIcon(
				FilePathConstants.EDIT_BUTTON_IMG));
