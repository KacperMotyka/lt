/**
 * @文件名称: FirstOddsFilterTask.java
 * @类路径:   com.rb.lottery.task.commonB
 * @描述:     TODO
 * @作者:     robin
 * @时间:     2011-12-13 下午12:43:16
 * @版本:     1.0.0
 */
 ...
 * @修改说明:
 * @作者: robin
 * @创建时间: 2011-12-13 下午12:43:16
 * @版本: 1.0.0
 */

public class FirstOddsFilterTask extends Task {

	private static final Logger log = Logger
			.getLogger(FirstOddsFilterTask.class);

	private float least;
	private float most;
	private boolean fatal;

	public FirstOddsFilterTask() {
		least = 0;
		most = 14;
		this.fatal = false;
	}

	public FirstOddsFilterTask(float least, float most, boolean ft) {
		this.least = least;
		this.most = most;
		this.fatal = ft;
	}
	...
	public void run() {
		...
		while (it.hasNext()) {
			...
			String fisrtBet = SystemProcessor.generateSpeOdds(1, key);
			...
			while (vit.hasNext()) {
				...
				int fbc = SystemFunctions.getMatchingCount(fisrtBet, bet);
