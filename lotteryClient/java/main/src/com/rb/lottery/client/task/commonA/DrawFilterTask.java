/**
 * @文件名称: DrawFilterTask.java
 * @类路径:   com.rb.lottery.task.commonA
 * @描述:     TODO
 * @作者:     robin
 * @时间:     2011-11-24 下午02:49:36
 * @版本:     1.0.0
 */
 ...
 * @修改说明:
 * @作者: robin
 * @创建时间: 2011-11-24 下午02:49:36
 * @版本: 1.0.0
 */

public class DrawFilterTask extends Task {

	private static final Logger log = Logger.getLogger(DrawFilterTask.class);
	
	private float least;
	private float most;
	private boolean fatal;

	public DrawFilterTask() {
		least = 0;
		most = 14;
		this.fatal =  false;
	}

	public DrawFilterTask(float least, float most, boolean ft) {
		this.least = least;
		this.most = most;
		this.fatal = ft;
	}
	...
	public void run() {
		...
		while (it.hasNext()) {
			...
			while (vit.hasNext()) {
				...
				int count = SystemFunctions.getCount(bet, SystemConstants.ONE);
