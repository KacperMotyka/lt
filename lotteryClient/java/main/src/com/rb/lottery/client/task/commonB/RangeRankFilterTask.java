/**
 * @文件名称: RangeRankFilterTask.java
 * @类路径:   com.rb.lottery.task.commonB
 * @描述:     TODO
 * @作者:     robin
 * @时间:     2011-12-13 下午04:23:27
 * @版本:     1.0.0
 */
 ...
 * @修改说明:
 * @作者: robin
 * @创建时间: 2011-12-13 下午04:23:27
 * @版本: 1.0.0
 */

public class RangeRankFilterTask extends Task {

	private static final Logger log = Logger
			.getLogger(RangeRankFilterTask.class);

	private float least;
	private float most;
	private boolean fatal;

	public RangeRankFilterTask() {
		least = 0;
		most = 4782969;
		this.fatal = false;
	}

	public RangeRankFilterTask(float least, float most, boolean ft) {
		this.least = least;
		this.most = most;
		this.fatal = ft;
	}
	...
	public void run() {
		...
		while (it.hasNext()) {
			...
			List<String> ranks = SystemProcessor.generateRanks(key);
